    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
        {fonts.map(({ label, value }) => (
          ...
          >
            <span className="texts-sm">{label}</span>
          </button>
        ))}
      </DropdownMenuContent>
    </DropdownMenu>
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 border border-neutral-400 text-center rounded-sm bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 w-10 border border-neutral-400 text-center rounded-sm bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
